...
files=(title.md template.md type.md io.md vector.md search.md string.md number.md matrix.md dp.md structure.md graph.md geometry.md game.md marathon.md data.md)
